		...
		<div
			...
			<div
				style={{
					...
					WebkitMaskImage: `url('${imagesBaseUri}/miura-wolf.png')`,
					WebkitMaskRepeat: "no-repeat",
					WebkitMaskSize: "contain",
					maskImage: `url('${imagesBaseUri}/miura-wolf.png')`,
				...
				<img src={imagesBaseUri + "/miura-wolf.png"} alt="MiuraCode logo" className="h-8 opacity-0" />
			</div>
			<div
