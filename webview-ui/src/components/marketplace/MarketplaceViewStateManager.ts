 ...
 *
 * This class manages the state for the marketplace view in the MiuraCode extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the MiuraCode extensions interface
